...
export default async function PublicReportPage({
  ...
  return (
    <main className="public-report-shell">
      <a className="skip-link" href="#report-content">
        Skip to campaign results
      </a>
      ...
      <div id="report-content" tabIndex={-1}>
        <section className="public-report-hero">
          ...
          <p>
            ...
            <time dateTime={report.sent_at}>{date.format(new Date(report.sent_at))}</time>
          </p>
        </section>
